...
/**
 * Hand-crafted SVG icons for RhythmTap.
 * Each icon accepts className and size (default 24).
 */
...
export function IconHeadphones({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconPlay({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M8 5.14v14.12a1 1 0 0 0 1.5.86l11-7.06a1 1 0 0 0 0-1.72l-11-7.06A1 1 0 0 0 8 5.14z" />
    </svg>
  );
}
...
export function IconWaveform({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconPulse({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
